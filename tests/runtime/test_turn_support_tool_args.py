"""Runtime parameter-model tool-argument resolution."""
...
from m_agent.runtime.turn_support.tool_runner import (
    RUNTIME_SKIP_PARAM_INSTRUCTION_ARG,
    build_tool_input,
)
...
def test_skip_param_instruction_arg_declares_recall_question() -> None:
    assert RUNTIME_SKIP_PARAM_INSTRUCTION_ARG["shallow_recall"] == "question"
    assert RUNTIME_SKIP_PARAM_INSTRUCTION_ARG["deep_recall"] == "question"

...
from m_agent.runtime.dispatch.cpu_state import THREAD_CPU_STATE, compute_runtime_phase
...
def test_config_max_preempt_loaded() -> None:
    cfg = RuntimeConfig(
        scheduler=SchedulerConfig(preempt_enabled=True, max_preempt_per_stimulus=5),
    )

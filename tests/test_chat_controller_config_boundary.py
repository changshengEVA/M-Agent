...
def test_chat_persona_prompt_is_loaded_from_chat_agent_config() -> None:
    ...
    chat_config = {
        ...
        "chat_persona_prompt": {
            "zh": "来自 chat agent 配置的人格设定",
            "en": "persona defined in the chat agent config",
        },
        "chat_system_prompt": {
    ...
    assert agent.chat_persona_prompt == "来自 chat agent 配置的人格设定"
    assert "来自 chat agent 配置的人格设定" in agent.chat_system_prompt

...
def test_chat_agent_english_prompts_are_language_neutral() -> None:
    ...
    chat_system_prompt_en = chat_config.get("chat_system_prompt", {}).get("en", "")
    chat_persona_prompt_en = chat_config.get("chat_persona_prompt", {}).get("en", "")

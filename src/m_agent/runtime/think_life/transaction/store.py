"""SQLite authority for the Think-life P2 transaction foundation."""
    ...
    def commit_flush(
        ...
        *,
        ...
        with self.unit_of_work() as uow:
            ...
            def is_flush_eligible(record: TransactionRecord) -> bool:
                activations = uow.list_activations(
                    record.transaction_id
                )
                delegates = uow.list_delegates(
                    transaction_id=record.transaction_id
            ...
            for transaction_id, expected_revision in expected.items():
                ...
                if not is_flush_eligible(record):
                    raise StoreInvariantError(

"""Runtime-neutral Harness facade over the current Think-life components."""
...
class ThinkLifeV1Harness:
    ...
    def __init__(
        ...
        *,
        ...
        self._legacy_scene_dir = self._persist_root / "legacy-scene"
        self._closed = False
    ...
    def _open_runtime_components(self) -> None:
        ...
        self.scene_store = SceneLogStore(
            ...
            persist_dir=self._legacy_scene_dir,
    ...
    def __enter__(self) -> "ThinkLifeV1Harness":
        return self
    ...
    def list_match_candidates(self, *, conversation_id: str) -> HarnessResult:
        ...
        return self._ok(
            ...
            candidate_legacy_statuses=[
                project_compat_status(item) for item in candidates
            ],

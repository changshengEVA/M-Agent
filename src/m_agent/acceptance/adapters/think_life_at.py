"""Think-life evidence drivers for the P1 AT semantic scenarios."""
...
def _at_01(
    ...
    evidence.check(
        ...
        expected=True,
        evidence="ThinkLifeV1Harness.restore_transaction",
    )
...
def _at_02(
    ...
    # pending delegate (legacy waiting_execution) is not a candidate.
    expected_ids = {
...
def _at_10(
    ...
    evidence.check(
        ...
        expected=True,
        evidence="ThinkLifeV1Harness.evaluate_matcher",
    )
    evidence.check(
        "matcher_runs_three_times",
...
_RUNNERS: Dict[
    str,
    Callable[[ThinkLifeV1Harness, str], ScenarioExecution],
] = {
    "AT-01": _at_01,
    "AT-02": _at_02,
    "AT-03": _at_03,

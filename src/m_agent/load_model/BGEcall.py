...
from m_agent.paths import ENV_PATH, MODEL_DIR
...
DEFAULT_LOCAL_DIR = MODEL_DIR / "BAAI__bge-m3"
...
def get_embed_model(
    ...
    resolved_cache_dir = cache_dir or os.getenv("EMBED_MODEL_CACHE_DIR", str(MODEL_DIR))

...
DEFAULT_MEMORY_AGENT_CONFIG_PATH = MEMORY_AGENT_CONFIG_DIR / "agent_sys.yaml"
DEFAULT_CHAT_AGENT_CONFIG_PATH = CHAT_AGENT_CONFIG_DIR / "test_agent_chat.yaml"
REALTALK_EVAL_CONFIG_PATH = EVAL_AGENT_CONFIG_DIR / "realtalk_eval.yaml"
DEFAULT_MEMORY_CORE_CONFIG_PATH = MEMORY_CORE_CONFIG_DIR / "agent_sys_memory.yaml"
